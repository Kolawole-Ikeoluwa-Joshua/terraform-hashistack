...
@app.route('/')
def index():
    return 'Welcome to the vtl-linux server registration app. Serving all your manual registration and deregistration needs! Valid paths are /register, /deregister, and /state.'
